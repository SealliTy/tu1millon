 ...
 */ (function (e) {
  ...
  function E(C, P) {
    ...
    try {
      for (
        d(P), v = t(s);
        v !== null && (!(v.expirationTime > P) || (C && !xe()));

      ) {
        var B = v.callback;
        if (typeof B == "function") {
          (v.callback = null), (p = v.priorityLevel);
          var X = B(v.expirationTime <= P);
          (P = e.unstable_now()),
...
function Jn(e, n) {
  for (Lt[e] = n, e = 0; e < n.length; e++) ns.add(n[e]);
}
var We = !(
    typeof window > "u" ||
...
function Gl(e, n) {
  ...
  n.hasOwnProperty("value")
    ? Zl(e, n.type, t)
    : n.hasOwnProperty("defaultValue") && Zl(e, n.type, fn(n.defaultValue)),
    n.checked == null &&
...
function Rc(e, n, t, r, l, u, o, i, s) {
  (Et = !1), (Lr = null), Tc.apply(Lc, arguments);
}
...
function It(e) {
  ...
  for (; 0 < qe.length && ((t = qe[0]), t.blockedOn === null); )
    Ls(t), t.blockedOn === null && qe.shift();
}
...
function Gu(e, n, t, r) {
  if (Dr) {
    ...
    else if ((Qo(e, r), n & 4 && -1 < Qc.indexOf(e))) {
      for (; l !== null; ) {
        var u = Zt(l);
        if (
          (u !== null && Ns(u),
...
var Ir = null;
function iu(e, n, t, r) {
  if (((Ir = null), (e = Qu(r)), (e = kn(e)), e !== null))
...
function Ef(e, n) {
  if (In)
    return e === "compositionend" || (!bu && Ds(e, n))
      ? ((e = Ms()), (kr = Zu = en = null), (In = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function ni() {
  _t && (_t.detachEvent("onpropertychange", Us), (Ft = _t = null));
}
function Us(e) {
  if (e.propertyName === "value" && nl(Ft)) {
    var n = [];
    Fs(n, Ft, e, Qu(e)), ys(_f, n);
  }
}
function Nf(e, n, t) {
  e === "focusin"
    ? (ni(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", Us))
    : e === "focusout" && ni();
}
function Pf(e) {
...
var Hs = tl("animationend"),
  Bs = tl("animationiteration"),
  Ws = tl("animationstart"),
  Qs = tl("transitionend"),
  Ks = new Map(),
  ui =
...
for (var Tl = 0; Tl < ui.length; Tl++) {
  var Ll = ui[Tl],
    Of = Ll.toLowerCase(),
    Df = Ll[0].toUpperCase() + Ll.slice(1);
  pn(Of, "on" + Df);
}
  ...
  if (!e[ar]) {
    (e[ar] = !0),
      ns.forEach(function (t) {
        t !== "selectionchange" && (If.has(t) || Rl(t, !1, e), Rl(t, !0, e));
      });
  ...
  ys(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        0 < k.length &&
          ((p = new g(p, w, null, t, m)), v.push({ event: p, listeners: k }));
      }
    }
    if (!(n & 7)) {
      e: {
      ...
      N &&
        (Os &&
          ...
          (In || N !== "onCompositionStart"
            ...
            : ((en = m),
              (Zu = "value" in en ? en.value : en.textContent),
              (In = !0))),
        (_ = Fr(c, N)),
        0 < _.length &&
          ((N = new Go(N, e, null, t, m)),
          v.push({ event: N, listeners: _ }),
          x ? (N.data = x) : ((x = Is(t)), x !== null && (N.data = x)))),
        (x = kf ? Sf(e, t) : Ef(e, t)) &&
          ((c = Fr(c, "onBeforeInput")),
          0 < c.length &&
            ((m = new Go("onBeforeInput", "beforeinput", null, t, m)),
...
var pu = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  $f =
    typeof queueMicrotask == "function"
      ...
      : typeof ai < "u"
        ? function (e) {
            return ai.resolve(null).then(e).catch(Af);
          }
        : pu;
function Af(e) {
  setTimeout(function () {
...
function vn() {
  if (!Dl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Ss(Ku, vn), l);
    } finally {
      (M = n), (Dl = !1);
    }
  }
...
function Js(e, n, t) {
  (we[ke++] = Ve), (we[ke++] = He), (we[ke++] = Nn), (Nn = e);
  var r = Ve;
  e = He;
  var l = 32 - Le(r) - 1;
  (r &= ~(1 << l)), (t += 1);
...
function ku(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ta), so(e);
  var u = n.contextType;
  typeof u == "object" && u !== null
    ? (l.context = Ce(u))
...
function la(e) {
  ...
  function w(f, a, d, h) {
    ...
    if (x === null) {
      for (; N < d.length; N++)
        (x = v(f, d[N], h)),
          x !== null &&
            ((a = u(x, a, N)), _ === null ? (E = x) : (_.sibling = x), (_ = x));
      return j && gn(f, N), E;
    }
  ...
  function k(f, a, d, h) {
    ...
    for (
      var _ = (E = null), x = a, N = (a = 0), H = null, L = d.next();
      x !== null && !L.done;
      N++, L = d.next()
    ) {
      x.index > N ? ((H = x), (x = null)) : (H = x.sibling);
    ...
    if (L.done) return t(f, x), j && gn(f, N), E;
    if (x === null) {
...
function ao(e, n) {
  switch ((O(Ht, n), O(Vt, e), O(je, Jt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function mo(e, n, t, r, l, u) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (Cr.current = e === null || e.memoizedState === null ? Gf : Zf),
    (e = t(r, l)),
    Nt)
  ) {
    u = 0;
    do {
      if (((Nt = !1), (Bt = 0), 25 <= u)) throw Error(y(301));
      (u += 1),
        (G = K = null),
        (n.updateQueue = null),
        (Cr.current = Jf),
...
function Pi(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), ra(n, t, r), ku(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
    ...
    (o.state = p),
      ...
      i !== r || p !== s || ce.current || Je
        ? (typeof m == "function" && (wu(n, t, m, r), (s = n.memoizedState)),
          (i = Je || yi(n, t, i, r, p, s, c))
            ? (v ||
...
function td(e, n, t) {
  ...
  switch ((to(n), n.tag)) {
        ...
        (e === null || e.child === null) &&
          (fr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Te !== null && (Du(Te), (Te = null)))),
        Nu(e, n),
        ne(n),
        null
      );
    ...
    case 4:
      return (
        nt(), Nu(e, n), e === null && Ut(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function ud(e, n) {
  ...
  for (fu = { focusedElem: e, selectionRange: t }, Dr = !1, S = n; S !== null; )
...
function ja(e) {
  ...
  n !== null && ((e.alternate = null), ja(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[mu], delete n[Vf], delete n[Hf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
    ...
    case 5:
      ...
      if (r & 4 && ((l = e.stateNode), l != null)) {
        ...
        if (((e.updateQueue = null), s !== null))
          try {
            i === "input" && u.type === "radio" && u.name != null && is(l, u),
              eu(i, o);
            var c = eu(i, u);
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Wo(t), n === 1))
      e.tag === 0 ? Bf(Fi.bind(null, e)) : Zs(Fi.bind(null, e)),
        $f(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function Ha(e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = uu(e)), l !== 0 && ((r = l), (n = Ou(e, l)))), n === 1)
    )
    ...
    if (n === 6) be(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = So + 500 - W()), 10 < n))
          ) {
            if (Or(e, 0) !== 0) break;
            ...
            e.timeoutHandle = pu(wn.bind(null, e, se, Ue), n);
            break;
          }
          wn(e, se, Ue);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = pu(wn.bind(null, e, se, Ue), r);
            break;
          }
          wn(e, se, Ue);
          break;
...
function wn(e, n, t) {
  var r = M,
    l = Ee.transition;
  try {
    (Ee.transition = null), (M = 1), fd(e, n, t, r);
  } finally {
    (Ee.transition = l), (M = r);
  }
  return null;
...
Xa = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if (!(e.lanes & t) && !(n.flags & 128)) return (ae = !1), nd(e, n, t);
      ae = !!(e.flags & 131072);
    }
  else (ae = !1), j && n.flags & 1048576 && Js(n, Vr, n.index);
...
function zr(e, n, t, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) xo(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Wl:
        return (
          (e = Se(12, t, n, l | 2)), (e.elementType = Wl), (e.lanes = u), e
        );
      case Ql:
        return (e = Se(13, t, n, l)), (e.elementType = Ql), (e.lanes = u), e;
      case Kl:
        return (e = Se(19, t, n, l)), (e.elementType = Kl), (e.lanes = u), e;
      case ls:
        return al(t, l, u, n);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Yu(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
...
vs = Eo;
hs = Tn;
var Sd = { usingClientEntryPoint: !1, Events: [Zt, Un, rl, ps, ms, Eo] },
  ht = {
...
var Cd = Ji.exports,
  ...
  nc,
  Ai = Cd;
(nc = Ai.createRoot), (ec = Ai.hydrateRoot);
const Lo = ({ value: e, name: n, hydrate: t = !0 }) => {
  if (!e) return null;
  const r = t ? "astro-slot" : "astro-static-slot";
  return Ae.createElement(r, {
    name: n,
    suppressHydrationWarning: !0,
    dangerouslySetInnerHTML: { __html: e },
  });
};
Lo.shouldComponentUpdate = () => !1;
function _d(e) {
...
function tc(e) {
  ...
  return e.firstChild === null
    ? Ae.createElement(e.localName, n)
    : Ae.createElement(
        e.localName,
        n,
...
function xd(e, n) {
  if (n && e) {
    ...
    r.innerHTML = e;
    for (let l of r.content.children) t.push(tc(l));
    return t;
  } else return e ? Ae.createElement(Lo, { value: e }) : void 0;
}
let Vi = new WeakMap();
const Hi = (e, n) => {
    let t = Vi.get(e);
    return t || ((t = n()), Vi.set(e, t)), t;
  },
  Nd =
    (e) =>
    (n, t, { default: r, ...l }, { client: u }) => {
      if (!e.hasAttribute("ssr")) return;
      const o = { identifierPrefix: e.getAttribute("prefix") };
      for (const [c, m] of Object.entries(l))
        t[c] = Ae.createElement(Lo, { value: m, name: c });
      const i = Ae.createElement(
          n,
          t,
          xd(r, e.hasAttribute("data-react-children")),
        ),
        s = _d(e);
      if ((s && delete e[s], u === "only"))
        return Ae.startTransition(() => {
          Hi(e, () => {
            const m = nc(e);
            return (
              e.addEventListener("astro:unmount", () => m.unmount(), {
                once: !0,
              }),
              m
            );
