export const HomeCard = ({ title, description, icon }) => {
  return (
    <div class="relative min-w-72 w-full rounded-xl p-5 xsm:flex xsm:flex-col xsm:pl-11 xsm:p-3 md:pl-14 md:w-1/4 xl:pl-16 xl:w-2/5">
      <div class="absolute inset-0 bg-white/70 backdrop-blur-sm rounded-xl -z-10"></div>
